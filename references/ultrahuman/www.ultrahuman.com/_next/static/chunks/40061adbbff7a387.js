(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 47194, (e, t, r) => {
    "use strict";
    ...
    let n = e.r(23486),
        ...
        i = e => {
            ...
            return /\.[^/]+\/?$/.test(t) ? `${(0,n.removeTrailingSlash)(t)}${r}${i}` : t.endsWith("/") ? `${t}${r}${i}` : `${t}/${r}${i}`
        };
        ...
        (() => {
            function t(e, t) {
                ...
                for (var r = function(e) {
                    ...
                    }(e), n = t.prefixes, i = void 0 === n ? "./" : n, o = t.delimiter, s = void 0 === o ? "/#?" : o, l = [], u = 0, c = 0, f = "", p = function(e) {
                    ...
                    var g = p("CHAR"),
                        ...
                        y = p("PATTERN");
                    if (P || y) {
                        var E = g || ""; - 1 === i.indexOf(E) && (f += E, E = ""), f && (l.push(f), f = ""), l.push({
                            name: P || u++,
                            prefix: E,
                            suffix: "",
                            pattern: y || _(E),
                    ...
                    for (var r = "", n = 0; n < e.length; n++) {
                        ...
                        if (Array.isArray(o)) {
                            ...
                            for (var f = 0; f < o.length; f++) {
                                var p = a(o[f], i);
                                if (s && !l[n].test(p)) throw TypeError('Expected all "'.concat(i.name, '" to match "').concat(i.pattern, '", but got "').concat(p, '"'));
                        ...
                        if ("string" == typeof o || "number" == typeof o) {
                            var p = a(String(o), i);
                            if (s && !l[n].test(p)) throw TypeError('Expected "'.concat(i.name, '" to match "').concat(i.pattern, '", but got "').concat(p, '"'));
                            r += i.prefix + p + i.suffix;
                            continue
                        }
                        if (!u) {
            ...
            function o(e, t, r) {
                ...
                for (var n = r.strict, o = void 0 !== n && n, s = r.start, l = r.end, u = r.encode, c = void 0 === u ? function(e) {
                        return e
                    } : u, f = r.delimiter, p = r.endsWith, h = "[".concat(a(void 0 === p ? "" : p), "]|$"), d = "[".concat(a(void 0 === f ? "/#?" : f), "]"), m = void 0 === s || s ? "^" : "", _ = 0; _ < e.length; _++) {
                    var g = e[_];
                    if ("string" == typeof g) m += a(c(g));
                        ...
                        if (g.pattern)
                            if (t && t.push(g), P || y)
                                if ("+" === g.modifier || "*" === g.modifier) {
                                    var E = "*" === g.modifier ? "?" : "";
                                    m += "(?:".concat(P, "((?:").concat(g.pattern, ")(?:").concat(y).concat(P, "(?:").concat(g.pattern, "))*)").concat(y, ")").concat(E)
                                } else m += "(?:".concat(P, "(").concat(g.pattern, ")").concat(y, ")").concat(g.modifier);
                        else {
                        ...
                        } else m += "(?:".concat(P).concat(y, ")").concat(g.modifier)
                    }
                }
                if (void 0 === l || l) o || (m += "".concat(d, "?")), m += r.endsWith ? "(?=".concat(h, ")") : "$";
                else {
                    var b = e[e.length - 1],
                        R = "string" == typeof b ? d.indexOf(b[b.length - 1]) > -1 : void 0 === b;
                    o || (m += "(?:".concat(d, "(?=").concat(h, "))?")), R || (m += "(?=".concat(d, "|").concat(h, ")"))
                }
            ...
            }, e.regexpToFunction = n, e.tokensToRegexp = o, e.pathToRegexp = s
        })(), t.exports = e
    })()
}, 58268, (e, t, r) => {
    "use strict";
    ...
    let i = "text/plain",
        ...
        X = "private-next-rsc-track-dynamic-import",
            ...
            case "catchall-intercepted-(...)":
                ...
                for (let e = r; e < i.segments.length; e++) {
                    ...
                    if ("static" === n.type) {
                        ...
                        o && e === r && o === n.interceptionMarker && (i = i.replace(n.interceptionMarker, "")), s.push(i)
                    } else {
    ...
    function u(e, t, r, n) {
        ...
        for (; u.length > 0;) {
            let {
                ...
                segment: r,
                parallelRoutes: f
            } = (0, o.parseLoaderTree)(e), p = (0, s.parseAppRouteSegment)(r);
            if (p ? .type === "dynamic" && !a.hasOwnProperty(p.param.paramName) && !n ? .has(p.param.paramName)) {
                let {
                    paramName: e,
                    paramType: r
                } = p.param, n = (0, l.resolveParamValue)(e, r, t, c, a);
                if (void 0 !== n) a[e] = n;
            ...
            let h = t;
            for (let e of (p && "route-group" !== p.type && "parallel-route" !== p.type && h++, Object.values(f))) u.push({
                tree: e,
                depth: h
            })
        }
    ...
    function h(e, t, r, n, a, c = {
        ...
        for (let f of (c = structuredClone(c), (0, l.removeTrailingSlash)(e).slice(1).split("/"))) {
            let e, l = o.INTERCEPTION_ROUTE_MARKERS.some(e => f.startsWith(e)),
                h = f.match(u.PARAMETER_PATTERN),
                P = l ? h ? .[1] : void 0;
            if (P && h ? .[2] ? (e = t ? i.NEXT_INTERCEPTION_MARKER_PREFIX : void 0, c.intercepted[h[2]] = P) : e = h ? .[2] && c.intercepted[h[2]] ? t ? i.NEXT_INTERCEPTION_MARKER_PREFIX : void 0 : t ? i.NEXT_QUERY_PARAM_PREFIX : void 0, P && h && h[2]) {
                let {
                    key: t,
                    pattern: r,
                    cleanedKey: n,
                ...
                _.push(r), g.push(`/${h[1]}:${c.names[t]??n}${i?o?"*":"+":""}`), c.names[t] ? ? = n
            } else if (h && h[2]) {
                n && h[1] && (_.push(`/${(0,s.escapeStringRegexp)(h[1])}`), g.push(`/${h[1]}`));
                let {
                    key: t,
                    pattern: r,
                    cleanedKey: i,
                ...
                n && h[1] && (u = u.substring(1)), _.push(u), g.push(`/:${c.names[t]??i}${o?l?"*":"+":""}`), c.names[t] ? ? = i
            } else _.push(`/${(0,s.escapeStringRegexp)(f)}`), g.push(`/${f}`);
            r && h && h[3] && (_.push((0, s.escapeStringRegexp)(h[3])), g.push(h[3]))
        }
        return {
    ...
    function d(e, t) {
        let r = h(e, t.prefixRouteKeys, t.includeSuffix ? ? !1, t.includePrefix ? ? !1, t.backreferenceDuplicateKeys ? ? !1, t.reference),
    ...
    function i(e, t, r = !0) {
        ...
        if (h !== o.origin) throw Object.defineProperty(Error(`invariant: invalid relative URL, router received ${e}`), "__NEXT_ERROR_CODE", {
            value: "E159",
            enumerable: !1,
            configurable: !0
        });
    ...
    function a(e) {
        return (void 0 === n && "u" > typeof window && (n = window.trustedTypes ? .createPolicy("nextjs", {
            createHTML: e => e,
            createScript: e => e,
            createScriptURL: e => e
        }) || null), n) ? .createScriptURL(e) || e
    }
    Object.defineProperty(r, "__esModule", {
        value: !0
    ...
    function g(e, t) {
        return _().then(r => {
            ...
            return {
                scripts: n.filter(e => e.endsWith(".js")).map(e => (0, i.__unsafeCreateTrustedScriptURL)(e) + d()),
    ...
    function P(e) {
        ...
        return {
            ...
            prefetch(t) {
                let r;
                return (r = navigator.connection) && (r.saveData || /2g/.test(r.effectiveType)) ? Promise.resolve() : g(e, t).then(e => Promise.all(h ? e.scripts.map(e => {
                    var t, r, n;
    ...
    function s(e) {
        let t;
        return o(e) ? e : Object.defineProperty(Error((0, i.isPlainObject)(e) ? (t = new WeakSet, JSON.stringify(e, (e, r) => {
    ...
    }), e.r(72796), ("function" == typeof r.default || "object" == typeof r.default && null !== r.default) && void 0 === r.default.__esModule && (Object.defineProperty(r.default, "__esModule", {
        value: !0
    }), Object.assign(r.default, r), t.exports = r.default)
}, 97742, (e, t, r) => {
    "use strict";
    ...
    }), e.r(83565), ("function" == typeof r.default || "object" == typeof r.default && null !== r.default) && void 0 === r.default.__esModule && (Object.defineProperty(r.default, "__esModule", {
        value: !0
    }), Object.assign(r.default, r), t.exports = r.default)
}, 57285, (e, t, r) => {
    "use strict";
    ...
    function h(e, t, r) {
        let h, d = "string" == typeof t ? t : (0, a.formatWithValidation)(t),
            m = d.match(/^[a-z][a-z0-9+.-]*:\/\//i),
            _ = m ? d.slice(m[0].length) : d;
    ...
    function o(e, t) {
        ...
        r && (0, i.pathHasPrefix)(l.pathname, r) && (l.pathname = (0, a.removePathPrefix)(l.pathname, r), l.basePath = r);
        let u = l.pathname;
        ...
        if (o) {
            let e = t.i18nProvider ? t.i18nProvider.analyze(l.pathname) : (0, n.normalizeLocalePath)(l.pathname, o.locales);
            l.locale = e.detectedLocale, l.pathname = e.pathname ? ? l.pathname, !e.detectedLocale && l.buildId && (e = t.i18nProvider ? t.i18nProvider.analyze(u) : (0, n.normalizeLocalePath)(u, o.locales)).detectedLocale && (l.locale = e.detectedLocale)
        }
        return l
    }
}, 42393, (e, t, r) => {
    ...
    (() => {
        ...
        i.parse = function(t, r) {
            ...
            return l
        }, e = decodeURIComponent, r = encodeURIComponent, n = /; */, a = /^[\u0009\u0020-\u007e\u0080-\u00ff]+$/, t.exports = i
    })()
}, 13993, (e, t, r) => {
    "use strict";
    ...
    function d(e) {
        ...
        let f = [],
            d = [];
        for (let e of ((0, u.safePathToRegexp)(l, d), d)) f.push(e.name);
        if (a) {
            let e = [];
        ...
        for (let [r, n] of (a && (t = (0, u.safeCompile)(a, {
                validate: !1
            })), Object.entries(i))) Array.isArray(n) ? i[r] = n.map(t => p(c(t), e.params)) : "string" == typeof n && (i[r] = p(c(n), e.params));
        ...
        try {
            ...
            t && (n.hostname = t(e.params)), n.pathname = a, n.hash = `${i?"#":""}${i||""}`, n.search = o ? p(o, e.params) : ""
        } catch (e) {
    ...
    function u(e, t, r, u, c, f) {
        let p, h = !1,
            ...
            _ = (0, i.removeTrailingSlash)((0, o.normalizeLocalePath)((0, s.removeBasePath)(m.pathname), f).pathname),
            g = r => {
                ...
                if (l) {
                    ...
                    if (m = n.parsedDestination, e = n.newUrl, Object.assign(u, n.parsedDestination.query), _ = (0, i.removeTrailingSlash)((0, o.normalizeLocalePath)((0, s.removeBasePath)(e), f).pathname), t.includes(_)) return h = !0, p = _, !0;
                    if ((p = c(_)) !== e && t.includes(p)) return h = !0, !0
                }
            },
            P = !1;
    ...
    async function B(e) {
        ...
        let {
            pathname: r
        } = (0, b.parsePath)(e.asPath), n = (0, T.hasBasePath)(r) ? (0, O.removeBasePath)(r) : r, a = (0, S.addBasePath)((0, R.addLocale)(n, e.locale));
    ...
    function W(e, t, r) {
        let [n, a] = (0, A.resolveHref)(e, t, !0), i = (0, m.getLocationOrigin)(), o = n.startsWith(i), s = a && a.startsWith(i);
        n = H(n), a = a ? H(a) : a;
        let l = o ? n : (0, S.addBasePath)(n),
            u = r ? H((0, A.resolveHref)(e, r)) : a || n;
        return {
            url: l,
            as: s ? u : (0, S.addBasePath)(u)
        }
    }

    function X(e, t) {
        let r = (0, l.removeTrailingSlash)((0, p.denormalizePagePath)(e));
            ...
            if (!s || o || s.includes("__next_data_catchall") || s.includes("/_error") || s.includes("/404") || (o = s), o) {
                if (o.startsWith("/")) {
                    ...
                    return Promise.all([r.router.pageLoader.getPageList(), (0, u.getClientBuildManifest)()]).then(([a, {
                        ...
                        let l = (0, R.addLocale)(s.pathname, s.locale);
                        if ((0, _.isDynamicRoute)(l) || !i && a.includes((0, h.normalizeLocalePath)((0, O.removeBasePath)(l), r.router.locales).pathname)) {
                            let r = (0, j.getNextPathnameInfo)((0, g.parseRelativeUrl)(e).pathname, {
                                nextConfig: void 0,
                                parseData: !0
                            });
                            t.pathname = l = (0, S.addBasePath)(r.pathname)
                        } {
                            let e = n(l, a, o, t.query, e => X(e, a), r.router.locales);
                            e.matchedPage && (t.pathname = e.parsedAs.pathname, l = t.pathname, Object.assign(t.query, e.parsedAs.query))
                        }
                        let u = a.includes(c) ? c : X((0, h.normalizeLocalePath)((0, O.removeBasePath)(t.pathname), r.router.locales).pathname, a);
                        if ((0, _.isDynamicRoute)(u)) {
                            let e = (0, P.getRouteMatcher)((0, y.getRouteRegex)(u))(l);
                ...
                let t = (0, b.parsePath)(e),
                    s = (0, x.formatNextPathnameInfo)({ ...(0, j.getNextPathnameInfo)(t.pathname, {
                            nextConfig: a,
                            parseData: !0
                        }),
    ...
    function z({
        ...
        let {
            href: c
        } = new URL(e, window.location.href), f = (0, k.getDeploymentId)(), p = s => (function e(t, r, n) {
            return fetch(t, {
                credentials: "same-origin",
                method: n.method || "GET",
        ...
        return l && o ? p({}).then(e => ("no-cache" !== e.response.headers.get("x-middleware-cache") && (t[c] = Promise.resolve(e)), e)) : void 0 !== t[c] ? t[c] : t[c] = p(s ? {
            method: "HEAD"
        } : {})
    }
    ...
    class Q {
        ...
        constructor(e, t, r, {
            ...
            this.sdc = {}, this.sbc = {}, this.isFirstPopStateEvent = !0, this._key = V(), this.onPopState = e => {
                ...
                this.isSsr && i === (0, S.addBasePath)(this.asPath) && l === (0, S.addBasePath)(this.pathname) || (!this._bps || this._bps(n)) && this.change("replaceState", a, i, Object.assign({}, o, {
                    shallow: o.shallow && this._shallow,
                    locale: o.locale || this.defaultLocale,
                    _h: 0
                }), t)
            };
            const b = (0, l.removeTrailingSlash)(e);
            ...
            if (this.basePath = "", this.sub = c, this.clc = null, this._wrapApp = o, this.isSsr = !0, this.isLocaleDomain = !1, this.isReady = !!(self.__NEXT_DATA__.gssp || self.__NEXT_DATA__.gip || self.__NEXT_DATA__.isExperimentalCompile || self.__NEXT_DATA__.appGip && !self.__NEXT_DATA__.gsp || !R && !self.location.search && 0), this.state = {
                    route: b,
                    pathname: e,
                    query: t,
                    asPath: R ? e : r,
                ...
                if (!r.startsWith("//")) {
                    ...
                    this._initialMatchesMiddlewarePromise = B({
                        ...
                        locale: p,
                        asPath: a
                    }).then(i => (n._shouldResolveHref = r !== e, this.changeState("replaceState", i ? a : (0, E.formatWithValidation)({
                        pathname: (0, S.addBasePath)(e),
                        query: t
                    }), a, n), i))
                }
        ...
        async _bfl(t, r, n, a) {
            {
                if (!this._bfl_s && !this._bfl_d) {
                    ...
                    try {
                        ...
                        return K({
                            url: (0, S.addBasePath)((0, R.addLocale)(t, n || this.locale, this.defaultLocale)),
                            router: this
                        }), new Promise(() => {})
                    }
                    let s = {
                    ...
                    !i && l && (i = l), r ? .numHashes && (this._bfl_s = new o(r.numItems, r.errorRate), this._bfl_s.import(r)), i ? .numHashes && (this._bfl_d = new o(i.numItems, i.errorRate), this._bfl_d.import(i))
                }
                let i = !1,
                    o = !1;
                for (let {
                    ...
                    if (e) {
                        let r = (0, l.removeTrailingSlash)(new URL(e, "http://n").pathname),
                            u = (0, S.addBasePath)((0, R.addLocale)(r, n || this.locale));
        ...
        async change(e, t, r, a, i) {
            ...
            let p = 1 === a._h;
            p || a.shallow || await this._bfl(r, void 0, a.locale);
            let h = p || a._shouldResolveHref || (0, b.parsePath)(t).pathname === (0, b.parsePath)(r).pathname,
                d = { ...this.state
                },
                A = !0 !== this.isReady;
            this.isReady = !0;
            ...
            this._inFlightRoute && this.clc && (w || Q.events.emit("routeChangeError", U(), this._inFlightRoute, D), this.clc(), this.clc = null), r = (0, S.addBasePath)((0, R.addLocale)((0, T.hasBasePath)(r) ? (0, O.removeBasePath)(r) : r, a.locale, this.defaultLocale));
            let $ = (0, v.removeLocale)((0, T.hasBasePath)(r) ? (0, O.removeBasePath)(r) : r, d.locale);
            this._inFlightRoute = r;
            let k = j !== d.locale;
            if (!p && this.onlyAHashChange($) && !k) {
                d.asPath = $, Q.events.emit("hashChangeStart", r, D), this.changeState(e, t, r, { ...a,
                    scroll: !1
                }), I && this.scrollToHash($);
                try {
                    await this.set(d, this.components[d.route], null)
                } catch (e) {
                    throw (0, f.default)(e) && e.cancelled && Q.events.emit("routeChangeError", e, $, D), e
                }
            ...
            this.urlIsNew($) || k || (e = "replaceState");
            let z = r;
            F = F ? (0, l.removeTrailingSlash)((0, O.removeBasePath)(F)) : F;
            let V = (0, l.removeTrailingSlash)(F),
                Y = r.startsWith("/") && (0, g.parseRelativeUrl)(r).pathname;
            if (this.components[F] ? .__appRouter) return K({
                url: r,
                router: this
            }), new Promise(() => {});
            let J = !!(Y && V !== Y && (!(0, _.isDynamicRoute)(V) || !(0, P.getRouteMatcher)((0, y.getRouteRegex)(V))(Y))),
                Z = !a.shallow && await B({
                    asPath: r,
                    locale: d.locale,
                    router: this
                });
            if (p && Z && (h = !1), h && "/_error" !== F)
                if (a._shouldResolveHref = !0, r.startsWith("/")) {
                    let e = n((0, S.addBasePath)((0, R.addLocale)($, d.locale), !0), o, s, q, e => X(e, o), this.locales);
                    if (e.externalDest) return K({
                        url: r,
                        router: this
                    }), !0;
                    Z || (z = e.asPath), e.matchedPage && e.resolvedHref && (F = e.resolvedHref, H.pathname = (0, S.addBasePath)(F), Z || (t = (0, E.formatWithValidation)(H)))
                } else H.pathname = X(F, o), H.pathname !== F && (F = H.pathname, H.pathname = (0, S.addBasePath)(F), Z || (t = (0, E.formatWithValidation)(H)));
            if (!(0, C.isLocalURL)(r)) return K({
                url: r,
                router: this
            }), !1;
            z = (0, v.removeLocale)((0, O.removeBasePath)(z), d.locale), V = (0, l.removeTrailingSlash)(F);
            let ee = !1;
            if ((0, _.isDynamicRoute)(V)) {
                let e = (0, g.parseRelativeUrl)(z),
                    n = e.pathname,
                    a = (0, y.getRouteRegex)(V);
                ee = (0, P.getRouteMatcher)(a)(n);
                let i = V === n,
                    o = i ? (0, L.interpolateAs)(V, n, q) : {};
                if (ee && (!i || o.result)) i ? r = (0, E.formatWithValidation)(Object.assign({}, e, {
                    pathname: o.result,
                    query: (0, M.omit)(q, o.params)
                })) : Object.assign(q, ee);
                else {
                    let e = Object.keys(a.groups).filter(e => !q[e] && !a.groups[e].optional);
                    if (e.length > 0 && !Z) throw Object.defineProperty(Error((i ? `The provided \`href\` (${t}) value is missing query values (${e.join(", ")}) to be interpolated properly. ` : `The provided \`as\` value (${n}) is incompatible with the \`href\` value (${V}). `) + `Read more: https://nextjs.org/docs/messages/${i?"href-interpolation-failed":"incompatible-href-as"}`), "__NEXT_ERROR_CODE", {
                        value: "E344",
                        enumerable: !1,
                        configurable: !0
                    })
            ...
            try {
                ...
                if (p || a.shallow || await this._bfl(r, "resolvedAs" in n ? n.resolvedAs : void 0, d.locale), "route" in n && Z) {
                    V = F = n.route || V, D.shallow || (q = Object.assign({}, n.query || {}, q));
                    let e = (0, T.hasBasePath)(H.pathname) ? (0, O.removeBasePath)(H.pathname) : H.pathname;
                    if (ee && F !== e && Object.keys(ee).forEach(e => {
                            ee && q[e] === ee[e] && delete q[e]
                        }), (0, _.isDynamicRoute)(F)) {
                        let e = !D.shallow && n.resolvedAs ? n.resolvedAs : (0, S.addBasePath)((0, R.addLocale)(new URL(r, location.href).pathname, d.locale), !0);
                        (0, T.hasBasePath)(e) && (e = (0, O.removeBasePath)(e));
                        let t = (0, y.getRouteRegex)(F),
                            a = (0, P.getRouteMatcher)(t)(new URL(e, location.href).pathname);
                        a && Object.assign(q, a)
                    }
                }
                if ("type" in n)
                ...
                if (s && s.unstable_scriptLoader && [].concat(s.unstable_scriptLoader()).forEach(e => {
                    ...
                    if (d.isPreview = !!n.props.__N_PREVIEW, n.props.notFound === G) {
                        let e;
                        try {
                ...
                p && "/_error" === this.pathname && self.__NEXT_DATA__.props ? .pageProps ? .statusCode === 500 && n.props ? .pageProps && (n.props.pageProps.statusCode = 500);
                let l = a.shallow && d.route === (n.route ? ? V),
                    u = a.scroll ? ? (!p && !l),
                    h = i ? ? (u ? {
                        x: 0,
                        y: 0
                ...
                if (p && et) {
                    ...
                    try {
                        await this.set(m, n, h)
                    } catch (e) {
                        throw (0, f.default)(e) && e.cancelled && Q.events.emit("routeChangeError", e, $, D), e
                    }
                    return !0
                }
                if (Q.events.emit("beforeHistoryChange", r, D), this.changeState(e, t, r, a), !(p && !h && !A && !k && (0, N.compareRouterStates)(m, this.state))) {
                    try {
                        await this.set(m, n, h)
                    } catch (e) {
                    ...
                    if (n.error) throw p || Q.events.emit("routeChangeError", n.error, $, D), n.error;
                    p || Q.events.emit("routeChangeComplete", r, D), u && /#.+$/.test(r) && this.scrollToHash(r)
                }
                return !0
            } catch (e) {
        ...
        changeState(e, t, r, n = {}) {
            ("pushState" !== e || (0, m.getURL)() !== r) && (this._shallow = n.shallow, window.history[e]({
                url: t,
                as: r,
                options: n,
                __N: !0,
        ...
        async handleRouteInfoError(e, t, r, n, a, i) {
            ...
            if ((0, u.isAssetError)(e) || i) throw Q.events.emit("routeChangeError", e, n, a), K({
                url: n,
                router: this
            }), U();
            console.error(e);
        ...
        async getRouteInfo({
            ...
            try {
                ...
                if (y && ("/_error" === t || "/404" === t) && (y.effect = void 0), p && (y ? y.json = self.__NEXT_DATA__.props : y = {
                ...
                if (y ? .effect ? .type === "rewrite") {
                    ...
                    if ((!p || o.includes(n)) && (_ = n, t = y.effect.resolvedHref, r = { ...r,
                            ...y.effect.parsedAs.query
                        }, a = (0, O.removeBasePath)((0, h.normalizeLocalePath)(y.effect.parsedAs.pathname, this.locales).pathname), e = this.components[_], i.shallow && e && this.route === _ && !s)) return { ...e,
                        route: _
                    }
                }
                if ((0, w.isAPIRoute)(_)) return K({
                    url: n,
                    router: this
                }), new Promise(() => {});
                let b = g || await this.fetchComponent(_).then(e => ({
                        Component: e.page,
                ...
                return b.__N_SSP && P.dataHref && T && delete this.sdc[T], this.isPreview || !b.__N_SSG || p || z(Object.assign({}, P, {
                    isBackground: !0,
                    persistCache: !1,
                    inflightCache: this.sbc
                })).catch(() => {}), S.pageProps = Object.assign({}, S.pageProps), b.props = S, b.route = _, b.query = r, b.resolvedAs = a, this.components[_] = b, b
            } catch (e) {
        ...
        async prefetch(e, t = e, r = {}) {
            ...
            if (t.startsWith("/")) {
                ...
                let i = n((0, S.addBasePath)((0, R.addLocale)(t, this.locale), !0), f, r, a.query, e => X(e, f), this.locales);
                if (i.externalDest) return;
                d || (p = (0, v.removeLocale)((0, O.removeBasePath)(i.asPath), this.locale)), i.matchedPage && i.resolvedHref && (a.pathname = o = i.resolvedHref, d || (e = (0, E.formatWithValidation)(a)))
            }
            a.pathname = X(a.pathname, f), (0, _.isDynamicRoute)(a.pathname) && (o = a.pathname, a.pathname = o, Object.assign(s, (0, P.getRouteMatcher)((0, y.getRouteRegex)(a.pathname))((0, b.parsePath)(t).pathname) || {}), d || (e = (0, E.formatWithValidation)(a)));
            let m = await F({
                fetchData: () => z({
                    dataHref: this.pageLoader.getDataHref({
                        href: (0, E.formatWithValidation)({
            ...
            if (m ? .effect.type === "rewrite" && (a.pathname = m.effect.resolvedHref, o = m.effect.resolvedHref, s = { ...s,
                ...
                }, p = m.effect.parsedAs.pathname, e = (0, E.formatWithValidation)(a)), m ? .effect.type === "redirect-external") return;
            let T = (0, l.removeTrailingSlash)(o);
            await this._bfl(t, p, r.locale, !0) && (this.components[i] = {
                __appRouter: !0
            }), await Promise.all([this.pageLoader._isSsg(T).then(t => !!t && z({
...
${e.stack}` : e + "")
    ...
    function P(e) {
        ...
        return t.events = s.default.events, h.forEach(r => {
            t[r] = (...t) => e[r](...t)
        }), t
    }("function" == typeof r.default || "object" == typeof r.default && null !== r.default) && void 0 === r.default.__esModule && (Object.defineProperty(r.default, "__esModule", {
        value: !0
